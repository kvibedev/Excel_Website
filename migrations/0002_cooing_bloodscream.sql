...
--> statement-breakpoint
ALTER TABLE "blog_posts" ADD COLUMN IF NOT EXISTS "approval_status" text DEFAULT 'none' NOT NULL;--> statement-breakpoint
ALTER TABLE "blog_posts" ADD COLUMN IF NOT EXISTS "approval_token" text;--> statement-breakpoint
ALTER TABLE "blog_posts" ADD COLUMN IF NOT EXISTS "approval_token_expires_at" timestamp;--> statement-breakpoint
DO $$ BEGIN
