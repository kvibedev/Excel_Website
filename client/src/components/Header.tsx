        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/vendor-registration">
              <Button
                variant="default"
                data-testid="link-vendor-registration"
              >
                Vendor Registration
              </Button>
            </Link>
          ...
          <div className="flex md:hidden items-center gap-2">
            <Link href="/contact">
              <Button size="sm" variant="default" className="bg-[#97CC06] text-[#063970] hover:bg-[#063970] hover:text-white" data-testid="button-mobile-get-estimate">
                Get an Estimate
              </Button>
            </Link>
            <button
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t">
            <nav className="flex flex-col gap-2">
              ...
              <Link href="/vendor-registration">
                <Button
                  variant={location === "/vendor-registration" ? "secondary" : "ghost"}
                  className="w-full justify-start"
                  onClick={() => setMobileMenuOpen(false)}
                  data-testid="link-mobile-vendor-registration"
                >
                  Vendor Registration
                </Button>
              </Link>
              ...
              <Link href="/contact">
                <Button
                  variant="default"
                  className="w-full bg-[#97CC06] text-[#063970] hover:bg-[#063970] hover:text-white"
                  onClick={() => setMobileMenuOpen(false)}
