      ...
      <Dialog open={!!selectedVendor} onOpenChange={() => setSelectedVendor(null)}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription className="sr-only">View and manage vendor details, notes, and assignments</DialogDescription>
          </DialogHeader>
          ...
          {selectedVendor && (
            <div className="space-y-6">
              ...
              <div>
                ...
                {isReadOnly ? (
                  <p className="mt-1"><Badge className={statusColors[selectedVendor.status] || "bg-gray-400"}>{selectedVendor.status}</Badge></p>
                ) : (
                  <Select
