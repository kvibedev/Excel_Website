...
import tailoredImage from "@assets/concrete_2_1774864766328.webp";
...
export default function ConcretePolishing() {
  const keyBenefits = [
    {
      icon: Sparkles,
      title: "Smoother & More Durable",
      description: "Your concrete will be smoother, more durable, and easier to clean.",
    },
    {
      icon: Shield,
      title: "Slip-Resistant",
      description: "Polished concrete is more slip-resistant than unsealed concrete.",
    },
    {
      icon: Gem,
      title: "Beautiful Showpiece",
      description: "Transform drab concrete into a beautiful showpiece.",
    },
    {
      icon: Target,
      title: "Safe High-Traffic Areas",
      description: "Give your business an edge with safe high-traffic areas.",
    },
    {
      icon: Building2,
      title: "Cost-Effective",
      description: "Cost-effective and long-lasting flooring solution.",
    },
  ];

  const polishingTasks = [
    { icon: Layers, title: "Surface Grinding", description: "Diamond abrasive grinding process to remove imperfections and create a smooth base." },
    { icon: Sparkles, title: "Floor Polishing", description: "Multi-stage polishing to achieve a high-gloss shine finish." },
    { icon: Droplets, title: "Concrete Sealing", description: "Protective sealer application to guard against stains and wear." },
    { icon: Eraser, title: "Stain Removal", description: "Surface imperfection removal for a flawless appearance." },
    { icon: FlaskConical, title: "Densifier Application", description: "Hardening treatment to increase durability and strength." },
    { icon: RotateCcw, title: "Maintenance Polish", description: "Ongoing floor maintenance to preserve the shine." },
  ];
  ...
  const howWeWorkSteps = [
    {
      step: "01",
      title: "Assessment",
      description: "We assess your concrete floor condition and offer personalized polishing solutions tailored to your facility.",
    },
    {
      step: "02",
      title: "Preparation",
      description: "Our team prepares the surface by applying coarse diamond abrasives to remove imperfections.",
    },
    {
      step: "03",
      title: "Polishing",
      description: "Fine diamond abrasives refine the surface until it meets the desired level of shine.",
    },
    {
      step: "04",
      title: "Sealing",
      description: "A protective sealer is applied to protect the polished surface from stains and wear.",
    },
  ];
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Advanced equipment for superior polishing results.",
    },
    {
      icon: Headphones,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Polished concrete floors provide a sleek, modern look while offering exceptional durability and easy maintenance for your commercial space.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/80 max-w-3xl mx-auto">
              Our concrete polishing process ensures a flawless finish every time
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-tasks">Commercial Concrete Polishing Services</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our comprehensive concrete polishing services cover every aspect of floor transformation
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {polishingTasks.map((task, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div className="order-2 lg:order-1 relative">
              <img
                src={tailoredImage}
                alt="Tailored Concrete Polishing Solutions"
                className="rounded-md w-full h-auto shadow-lg"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-1">
                At Excel Facility Services Group, we specialize in concrete polishing services that elevate the aesthetics and functionality of your commercial space. Polished concrete floors not only provide a <strong>sleek and modern look</strong> but also enhance the overall durability and resistance of your flooring.
              </p>
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-2">
                Our team employs <strong>advanced techniques and state-of-the-art equipment</strong> to achieve a high-gloss finish that transforms dull concrete into a beautiful and professional surface.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#063970]/80 max-w-3xl mx-auto">
              EFSG is the perfect partner for your business. We provide tailored concrete polishing solutions that meet your specific needs.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-white/80 mb-10">
              Partner with EFSG to create beautiful, professional polished concrete floors that reflect your brand's image.
            </p>
