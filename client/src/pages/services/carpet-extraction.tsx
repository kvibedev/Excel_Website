...
import tailoredImage from "@assets/Carpet_1_1774865037593.webp";
...
export default function CarpetExtraction() {
  const keyBenefits = [
    {
      icon: Sparkles,
      title: "Remove Dirt & Allergens",
      description: "Remove dirt, dust, and allergens from carpets for a cleaner environment.",
    },
    {
      icon: Clock,
      title: "Prolong Carpet Life",
      description: "Prolong the life of your carpets with professional extraction services.",
    },
    {
      icon: Heart,
      title: "Employee Health & Safety",
      description: "Keep employees healthy and safe by removing allergens from carpets.",
    },
    {
      icon: Shield,
      title: "Protect Your Investment",
      description: "Protect your investment in expensive commercial carpeting.",
    },
    {
      icon: Leaf,
      title: "Gentle on Fibers",
      description: "Gentle on carpet fibers, making it ideal for sensitive carpets.",
    },
  ];

  const extractionTasks = [
    { icon: Droplets, title: "Hot Water Extraction", description: "Deep steam cleaning method that penetrates carpet fibers for thorough cleaning." },
    { icon: Trash2, title: "Stain Removal", description: "Stubborn stain treatment using specialized solutions and techniques." },
    { icon: Wind, title: "Allergen Removal", description: "Dust mite and allergen extraction for healthier indoor air quality." },
    { icon: Sparkles, title: "Carpet Deodorizing", description: "Fresh scent treatment that eliminates odors at the source." },
    { icon: Target, title: "Traffic Lane Cleaning", description: "High-traffic area focus to restore heavily used carpet sections." },
    { icon: Zap, title: "Quick Dry Service", description: "Fast drying techniques to minimize business disruption." },
  ];
  ...
  const howWeWorkSteps = [
    {
      step: "01",
      title: "Assessment",
      description: "We assess your carpet's condition and identify specific cleaning needs and problem areas.",
    },
    {
      step: "02",
      title: "Custom Plan",
      description: "Our team develops a customized extraction plan that fits your schedule and carpet type.",
    },
    {
      step: "03",
      title: "Execute",
      description: "Certified technicians perform extraction using state-of-the-art equipment and techniques.",
    },
    {
      step: "04",
      title: "Quality Check",
      description: "Thorough inspection ensures complete satisfaction and optimal carpet restoration.",
    },
  ];
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Advanced extraction equipment for best results.",
    },
    {
      icon: Headphones,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-benefits">
              Why Professional Carpet Extraction Matters
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Professional carpet extraction delivers deep cleaning results that protect your investment and create a healthier workplace.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-1">
                What sets Excel Facility Services Group apart from others in the industry is our commitment to utilizing <strong>cutting-edge extraction technology</strong> to enhance our services. With our advanced equipment, we deliver deeper cleaning results while minimizing drying times.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#063970]/80 max-w-3xl mx-auto">
              EFSG is the perfect partner for your business. We provide tailored carpet extraction solutions that meet your specific needs.
            </p>
          </div>
        </div>
