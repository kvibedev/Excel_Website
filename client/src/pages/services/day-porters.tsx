        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8" data-testid="text-about-3">With more than 20 years of operational experience and multi-site capability, Excel helps organizations maintain cleaner, safer, and more consistent environments through responsive service delivery and dependable daytime support.</p>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-tasks">Comprehensive Day Porter Services</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-3">
                We offer flexible scheduling options to accommodate your operational hours, ensuring that our day porter services align with your business needs. Our trained staff uses state-of-the-art equipment and <Link href="/about-us" className="text-[#0A5EB9] font-semibold hover:underline" data-testid="link-eco">eco-friendly products</Link> to deliver effective cleaning solutions without disrupting your daily operations.
              </p>
