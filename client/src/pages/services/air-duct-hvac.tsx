...
export default function AirDuctHVAC() {
  const keyBenefits = [
    {
      icon: Heart,
      title: "Healthy & Productive",
      description: "Keep employees and visitors healthy and productive.",
    },
    {
      icon: Settings,
      title: "Extend Equipment Life",
      description: "Extend equipment life and reduce energy costs.",
    },
    {
      icon: Wind,
      title: "Remove Contaminants",
      description: "Remove contaminants and odors from the air.",
    },
    {
      icon: Users,
      title: "Comfortable Environment",
      description: "Employees will be grateful for comfortable environment.",
    },
    {
      icon: Shield,
      title: "Prevent Illness",
      description: "Prevent the spread of illnesses.",
    },
  ];

  const hvacTasks = [
    { icon: Fan, title: "Duct Cleaning", description: "Complete air duct cleaning and sanitization." },
    { icon: Thermometer, title: "HVAC Maintenance", description: "Regular system checkups and repairs." },
    { icon: Filter, title: "Filter Replacement", description: "Timely air filter changes." },
    { icon: Wind, title: "Vent Cleaning", description: "Clean supply and return vents." },
    { icon: Snowflake, title: "Coil Cleaning", description: "Evaporator and condenser coil maintenance." },
    { icon: Activity, title: "Air Quality Testing", description: "Indoor air quality assessments." },
  ];
  ...
  const howWeWorkSteps = [
    {
      step: "01",
      title: "Assessment",
      description: "We assess your HVAC system and air ducts to identify areas needing attention and develop a tailored solution.",
    },
    {
      step: "02",
      title: "Custom Plan",
      description: "Our team works closely with you to develop a customized maintenance plan that fits your schedule.",
    },
    {
      step: "03",
      title: "Execute",
      description: "Our certified technicians execute all cleaning and maintenance tasks with precision and efficiency.",
    },
    {
      step: "04",
      title: "Quality Check",
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="relative">
              <img
                src={sectionImage}
                alt="Professional Air Duct & HVAC Services"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-benefits">
              Why Professional Air Duct & HVAC Services Matter
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Investing in professional air duct and HVAC cleaning services creates a healthier environment and saves you money in the long run.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-1">
                What sets Excel Facility Services Group apart from others in the industry is our commitment to utilizing <strong>cutting-edge technology</strong> to enhance our services. With our advanced equipment and trained technicians, we ensure thorough cleaning of your air ducts and HVAC systems.
              </p>
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-2">
                We understand the importance of prompt responses and timely answers to your needs and questions. Our dedicated team works tirelessly behind the scenes to ensure that your HVAC services are <strong>consistent and delivered on time</strong>.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#063970]/80 max-w-3xl mx-auto">
              EFSG is the perfect partner for your business. We provide tailored HVAC solutions that meet your specific needs.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-6">
              Excel Facility Services Group provides professional air duct and HVAC cleaning services that can help create a healthier environment for your employees and customers.
            </p>
            <p className="text-lg text-white/80 mb-10">
              Partner with EFSG to ensure clean air, efficient systems, and a comfortable environment that reflects your commitment to wellness.
            </p>
