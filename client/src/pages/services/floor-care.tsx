...
import sectionImage from "@assets/floor_care_3_1774863878995.webp";
import tailoredImage from "@assets/floor_care_2_1774863933749.webp";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8" data-testid="text-about-3">
                With more than 20 years of operational experience and multi-site capability, Excel helps organizations maintain stronger floor performance through dependable service delivery, tailored care plans, and attention to the demands of each floor type.
              </p>
      ...
      <section className="py-16 md:py-24 bg-[#f0f2f5]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">Professional floor care helps commercial facilities maintain stronger appearance, support safer conditions, and extend the life of flooring in high-traffic environments.</p>
          </div>
