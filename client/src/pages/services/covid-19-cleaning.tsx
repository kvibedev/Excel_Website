...
import heroImage from "@assets/Covid_19_BG_image_2_1774982230106.webp";
...
export default function Covid19Cleaning() {
  const keyBenefits = [
    {
      icon: ShieldCheck,
      title: "Clean & Safe",
      description: "Keep your office clean and safe from bacteria and viruses, including COVID-19.",
    },
    {
      icon: Droplets,
      title: "Complete Package",
      description: "Get a complete package of cleaning services designed to kill germs and viruses.",
    },
    {
      icon: SprayCan,
      title: "Latest Equipment",
      description: "Use the latest equipment and techniques to disinfect your office.",
    },
    {
      icon: Award,
      title: "Certified Professionals",
      description: "Feel reassured that your workplace is being cleaned by certified professionals.",
    },
    {
      icon: HeartPulse,
      title: "Healthy Workplace",
      description: "Create a safe and healthy workplace for everyone.",
    },
  ];

  const cleaningTasks = [
    { icon: SprayCan, title: "Surface Disinfection", description: "Complete sanitization of all surfaces throughout your facility." },
    { icon: Hand, title: "High-Touch Areas", description: "Door handles, elevator buttons, switches and frequently touched surfaces." },
    { icon: AirVent, title: "Air Quality", description: "HVAC and ventilation cleaning to ensure clean air circulation." },
    { icon: Monitor, title: "Workspace Sanitization", description: "Desks, chairs, shared equipment and personal workspaces." },
    { icon: DoorOpen, title: "Common Areas", description: "Lobbies, break rooms, restrooms and shared spaces." },
    { icon: ClipboardCheck, title: "Certified Protocols", description: "Following CDC and health guidelines for maximum protection." },
  ];
  ...
  const howWeWorkSteps = [
    {
      step: "01",
      title: "Assessment",
      description: "We assess your facility's specific needs and identify high-risk areas requiring enhanced disinfection.",
    },
    {
      step: "02",
      title: "Custom Plan",
      description: "Our team develops a customized COVID-19 cleaning plan tailored to your workplace requirements.",
    },
    {
      step: "03",
      title: "Execute",
      description: "Certified professionals execute all disinfection tasks using EPA-approved products and techniques.",
    },
    {
      step: "04",
      title: "Quality Check",
      description: "Rigorous quality control ensures complete sanitization and compliance with health guidelines.",
    },
  ];
  ...
  return (
    <div>
      ...
      <Hero
        title="COVID-19 Cleaning"
        subtitle="To help keep employees and customers safe, Excel Facility Services Group has adapted its commercial cleaning services to meet the new reality of the business world with its COVID-19 Cleaning Service."
        imageSrc={heroImage}
        height="medium"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6" data-testid="heading-about">
                Keeping Your Premises Safe and Clean
              </h2>
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-about-1">
                COVID-19 Cleaning is the perfect solution for corporate offices that want to keep their premises safe and clean. EFSG offers a complete package of cleaning services designed to kill bacteria and viruses, including the COVID-19 virus.
              </p>
            ...
            <div className="relative">
              <img
                src={sectionImage}
                alt="COVID-19 Cleaning Services"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-benefits">
              Why COVID-19 Cleaning Matters
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Protect your employees, customers, and business with professional COVID-19 cleaning services designed to eliminate harmful pathogens.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/80 max-w-3xl mx-auto">
              Our dedicated team works closely with you to guarantee your utmost satisfaction and safety
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-tasks">
              COVID-19 Cleaning Tasks
            </h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Our comprehensive COVID-19 cleaning services cover every aspect of your facility to ensure maximum protection
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div className="order-2 lg:order-1 relative">
              <img
                src={tailoredImage}
                alt="Professional COVID-19 Disinfection"
                className="rounded-md w-full h-auto shadow-lg"
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-1">
                What sets Excel Facility Services Group apart from others in the industry is our commitment to utilizing <strong>cutting-edge technology</strong> and EPA-approved disinfectants to enhance our COVID-19 cleaning services. Our advanced protocols ensure thorough sanitization of your entire facility.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-[#063970]/80 max-w-3xl mx-auto">
              EFSG provides COVID-19 cleaning services across all industries. We offer tailored solutions that meet your specific safety needs.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6" data-testid="heading-cta">
              Ready for Professional COVID-19 Cleaning?
            </h2>
            <p className="text-xl text-white/90 mb-6">
              Excel Facility Services Group delivers reliable and consistent COVID-19 cleaning services to businesses of all sizes. We have the experience and expertise to keep your facility safe.
            </p>
            <p className="text-lg text-white/80 mb-10">
              Partner with EFSG to create a safe and healthy environment that protects your employees and customers.
            </p>
