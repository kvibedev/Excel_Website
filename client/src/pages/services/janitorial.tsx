          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-about-1">
                Janitorial services play a critical role in maintaining clean, professional, and healthy commercial environments. From <Link href="/industries/office-building" className="text-[#0A5EB9] font-semibold hover:underline" data-testid="link-office">office buildings</Link> and <Link href="/industries/retailer" className="text-[#0A5EB9] font-semibold hover:underline" data-testid="link-retail">retail stores</Link> to <Link href="/industries/distribution-centers" className="text-[#0A5EB9] font-semibold hover:underline" data-testid="link-distribution">distribution centers</Link> and other high-traffic facilities, consistent cleaning supports workplace presentation, hygiene, and day-to-day operational standards.
              </p>
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-about-2">
                Excel Facility Services Group delivers janitorial services through trained teams, structured routines, and service oversight designed to support consistency across client sites. Our approach helps organizations maintain dependable cleaning standards with accountability, responsiveness, and attention to detail.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-tailored-3">
                We offer flexible scheduling options to accommodate your operational hours, ensuring that our cleaning services align with your business needs. Our trained staff uses state-of-the-art equipment and <Link href="/about-us" className="text-[#0A5EB9] font-semibold hover:underline" data-testid="link-eco">eco-friendly products</Link> to deliver effective cleaning solutions without disrupting your daily operations.
              </p>
